...
namespace FarmTradeApp.ViewModels
{
    public class MarketEntryFormViewModel
    {
        ...
        public string Action
        {
            get
            {
                Expression<Func<MarketEntriesController, ActionResult>> update = (c => c.Update(this));
                Expression<Func<MarketEntriesController, ActionResult>> create = (c => c.Create(this));
