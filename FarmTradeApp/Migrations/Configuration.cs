namespace FarmTradeApp.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<FarmTradeApp.DAL.ApplicationDbContext>
    {
        ...
        protected override void Seed(FarmTradeApp.DAL.ApplicationDbContext context)
        {
            ...
            {
                Auction.Initialize(new DateTime(2019, 07, 31))
            };
